...
clang -g -O3 $defines -Wall -Wno-unused-function -unused-function -nostdlib --target=wasm32 -msimd128 -mbulk-memory -Wall main.cpp .\wasm\wasm.cpp -Xlinker "--reproduce=build\wasm\main.wasm.map" -o build\wasm\main.wasm
