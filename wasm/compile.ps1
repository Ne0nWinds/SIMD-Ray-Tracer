...
clang -Ofast $defines -Wall -Wno-unused-function -unused-function -nostdlib --target=wasm32 -msimd128 -mbulk-memory -Wall main.cpp .\wasm\wasm.cpp -Xlinker "--no-entry" -o build\wasm\main.wasm
