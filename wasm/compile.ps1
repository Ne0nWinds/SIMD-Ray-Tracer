...
#>
emcc -O2 main.cpp wasm\wasm.cpp $defines -sALLOW_MEMORY_GROWTH -sASSERTIONS -sMAX_WEBGL_VERSION=1 -pthread -msimd128 -mbulk-memory -o build\wasm\main.wasm -o build\wasm\wasm_glue.js
